...
describe('model', function() {
  ...
  describe('.export()', function() {
    ...
    it('should perform sandbox ops', function(done) {
      ...
      client.model.sandboxOps.eventTypesOps
        .create([
          {
            key,
            description: '',
        ...
        .then(() => {
          return client.model.sandboxOps.objectTypesOps
            .create({
              key,
              description: '',
              displayName: '',
        ...
        .then(() => {
          return client.model.sandboxOps.timeseriesOps
            .create([
              {
                key: tsKey,
                description: '',
            ...
            .then(() => {
              return client.model.sandboxOps.timeseriesOps.update(tsKey, {
                description: 'new desc',
                displayName: 'new dp',
              });
            })
        ...
        .then(() => {
          return;
          client.model.sandboxOps.objectAttributesOps
            .create({
              key: objKey,
              description: '',
              displayName: '',
            ...
            .then(() => {
              return client.model.sandboxOps.objectAttributesOps.update(objKey, {
                description: 'new desc',
                displayName: 'new dp',
              });
            })
        ...
        .then(() => {
          return client.model.sandboxOps.ownerAttributesOps
            .create({
              key: ownKey,
              description: '',
              displayName: '',
            ...
            .then(() => {
              return client.model.sandboxOps.ownerAttributesOps.update(ownKey, {
                description: 'new desc',
                displayName: 'new dp',
              });
            })
